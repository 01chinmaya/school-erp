...
-- CreateEnum
CREATE TYPE "GradeCategory" AS ENUM ('EXAM', 'QUIZ', 'ASSIGNMENT', 'PROJECT');

-- CreateEnum
CREATE TYPE "InvoiceStatus" AS ENUM ('PAID', 'PENDING');

-- CreateEnum
CREATE TYPE "InvoiceCategory" AS ENUM ('TUITION', 'TRANSPORT', 'SPORTS', 'LIBRARY', 'LUNCH', 'UNIFORM', 'OTHER');
